...
insert into Customer (customer_name,customer_surname,customer_gender,customer_phone_num,
                        customer_email,customer_country,customer_city,customer_street,customer_password)
values ('Petar','Petrovic','m','+38163444736','ppetrovic@gmail.com','Serbia','Novi Sad','Bulevar Oslobodjenja bb','petar');

insert into Book_Order (order_date,order_price,order_status, customer_id) values (parsedatetime('17-09-2012 18:47:52.690', 'dd-MM-yyyy hh:mm:ss.SS'), 1000,'Complete',1);
insert into Book_Order (order_date,order_price,order_status,customer_id) values (parsedatetime('17-09-2012 18:47:52.690', 'dd-MM-yyyy hh:mm:ss.SS'), 1,'Test',1);
